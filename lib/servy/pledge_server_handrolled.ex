defmodule Servy.PledgeServerHandRolled do
  ...
  @pledge_server_handrolled_pid :pledge_server_handrolled_pid # a constant
  @external_service_url "https://httparrot.herokuapp.com"

  alias Servy.GenericServer

  def start do
    GenericServer.start_server(__MODULE__,[], @pledge_server_handrolled_pid)
  end

  # Client Process

  def create_pledge( name, amount) do
    GenericServer.call @pledge_server_handrolled_pid, {:create_pledge, name, amount}
  end

  def recent_pledges() do
    # Returns the most recent pledges (cache)
    GenericServer.call @pledge_server_handrolled_pid, :recent_pledges
  end
  ...
  def total_pledged do
    GenericServer.call @pledge_server_handrolled_pid, :total_pledged
  end

  def clear do
    GenericServer.cast @pledge_server_handrolled_pid, :clear
  end
...
#pid = PledgeServerHandRolled.start_server()
